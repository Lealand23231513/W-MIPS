...
set_max_delay -to [get_ports *ram*] 4.200

set_max_delay -from [get_ports *ram_data*] -to [get_cells -hierarchical *data_bus_resp_reg*] 4.200

set_max_delay -from [get_ports -filter { NAME =~  "*ram_data*" && DIRECTION == "INOUT" }] -to [get_cells -hierarchical *data_r_ori_buf_reg*] 4.200
